	...
	, p_mainEngine(pEngine)
{
	...
	m_iCurrentScreenX = m_iPreviousScreenX = 550;
	m_iCurrentScreenY = m_iPreviousScreenY = 255;
...
TrafficLightNE::~TrafficLightNE(void)
{

}

void TrafficLightNE::Draw(void)
{
	if (green == true) {
...
void TrafficLightNE::DoUpdate(int iCurrentTime) {
